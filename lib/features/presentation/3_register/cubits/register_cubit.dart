...
class RegisterCubit extends Cubit<RegisterState> {
  ...
  void toggleRole(UserRoleEnum role) {
  ...
  void navigateToNextScreen(BuildContext context) {
    ...
    if (state.userRole == UserRoleEnum.student) {
      context.pushNamed(RouteConstants.signupAsStudentScreenRoute);
    } else {
      context.pushNamed(RouteConstants.signupAsInstructorScreenRoute);
    }
  }
}
