...
import 'package:ElevatED/features/presentation/course_details/screen/widgets/course_header.dart';
import 'package:ElevatED/features/presentation/course_details/screen/widgets/instructor_list_tile.dart';
import 'package:ElevatED/features/presentation/course_details/screen/widgets/video_list_tile.dart';
  ...
  PreferredSizeWidget? get _getCourseDetailsAppBar {
    return AppBar(
      ...
      title: Text("Course Details",
          style: getMediumStyle(fontSize: 24.sp, color: MyTheme.textColor)),
      actions: [
        IconButton(
          onPressed: () {
