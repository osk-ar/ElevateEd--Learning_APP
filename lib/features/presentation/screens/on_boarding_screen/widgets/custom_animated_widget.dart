...
import 'package:e_learning_app_gp/features/presentation/screens/on_boarding_screen/widgets/floating_text_container.dart';
import 'package:e_learning_app_gp/features/presentation/screens/on_boarding_screen/widgets/image_container.dart';
        ...
        child: Stack(
          ...
          children: [
            AnimatedFloatingContainer(
              ...
              movementCurve: Curves.easeOutQuint,
              rotationCurve: Curves.easeOutQuint,
              backgroundColor: MyTheme.textColor,
              textColor: MyTheme.inverseTextColor,
              floatingDistance: 5.r,
              animationDuration: widget.textAnimationDuration,
